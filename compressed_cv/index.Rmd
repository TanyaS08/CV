...
My research asks when ecological networks are meaningful representations of ecological systems, and when they are not. I develop computational and theoretical frameworks that treat networks as scale-dependent, constraint-driven, and inherently uncertain, linking interaction assembly, system embedding, and ecological inference. This work aims to define the limits of predictability in ecology and to build principled, open tools for inference under those constraints.
