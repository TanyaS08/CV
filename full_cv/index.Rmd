...
tribble(
  ...
  "Postdoctoral Researcher","Advisor: A.P. Beckerman, PhD", "2024 - Present", "University of Sheffield", "Sheffield, UK",
...
tribble(
  ~ Degree, ~Advisor, ~ Year, ~ Institution, ~ Where,
  "Doctor of Philosophy in Biological Sciences","Advisor: T. Poisot, PhD", "2020 - Present", "Université de Montréal", "Montréal, Canada",
  "Doctor of Philosophy in Biological Sciences","Thesis: Tools 'O the Times: Understanding the common properties of species interaction networks across space", "2020 - Present", "Université de Montréal", "Montréal, Canada",
...
```{r}
bibliography_entries("../bib/under_review.bib")
```
